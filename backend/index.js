...
app.get("/getNameAndBalance", async (req, res) => {
  ...
  const response = await Moralis.EvmApi.utils.runContractFunction({
    chain: "0x13881",
    address: "0x8dDeEdfd88B9faB0B0b23ba108E5f7049Fe90c9e",
  ...
  const jsonResponseHistory = fourResponse.raw
    ? convertArrayToObjects(fourResponse.raw)
    : [];
  ...
  const jsonResponseRequests = fiveResponse.raw ? fiveResponse.raw : [];
